...
//go:generate minimock -i github.com/Ghaarp/auth/internal/repository.AuthRepository -o auth_repository_minimock.go -n AuthRepositoryMock -p mocks
...
type AuthRepositoryMock struct {
	...
	ClosePoolMock          mAuthRepositoryMockClosePool
...
func NewAuthRepositoryMock(t minimock.Tester) *AuthRepositoryMock {
	...
	m.ClosePoolMock = mAuthRepositoryMockClosePool{mock: m}
	m.ClosePoolMock.callArgs = []*AuthRepositoryMockClosePoolParams{}
...
type mAuthRepositoryMockClosePool struct {
	optional           bool
	mock               *AuthRepositoryMock
	defaultExpectation *AuthRepositoryMockClosePoolExpectation
	expectations       []*AuthRepositoryMockClosePoolExpectation

	callArgs []*AuthRepositoryMockClosePoolParams
	mutex    sync.RWMutex
...
// AuthRepositoryMockClosePoolExpectation specifies expectation struct of the AuthRepository.ClosePool
type AuthRepositoryMockClosePoolExpectation struct {
	mock               *AuthRepositoryMock
	params             *AuthRepositoryMockClosePoolParams
	paramPtrs          *AuthRepositoryMockClosePoolParamPtrs
	expectationOrigins AuthRepositoryMockClosePoolExpectationOrigins

	returnOrigin string
	Counter      uint64
}

// AuthRepositoryMockClosePoolParams contains parameters of the AuthRepository.ClosePool
type AuthRepositoryMockClosePoolParams struct {
	ctx context.Context
}

// AuthRepositoryMockClosePoolParamPtrs contains pointers to parameters of the AuthRepository.ClosePool
type AuthRepositoryMockClosePoolParamPtrs struct {
	ctx *context.Context
}

// AuthRepositoryMockClosePoolOrigins contains origins of expectations of the AuthRepository.ClosePool
type AuthRepositoryMockClosePoolExpectationOrigins struct {
	origin    string
	originCtx string
}
...
func (mmClosePool *mAuthRepositoryMockClosePool) Optional() *mAuthRepositoryMockClosePool {
	mmClosePool.optional = true
	return mmClosePool
}

// Expect sets up expected params for AuthRepository.ClosePool
func (mmClosePool *mAuthRepositoryMockClosePool) Expect(ctx context.Context) *mAuthRepositoryMockClosePool {
	if mmClosePool.mock.funcClosePool != nil {
		mmClosePool.mock.t.Fatalf("AuthRepositoryMock.ClosePool mock is already set by Set")
	}

	if mmClosePool.defaultExpectation == nil {
		mmClosePool.defaultExpectation = &AuthRepositoryMockClosePoolExpectation{}
	}

	if mmClosePool.defaultExpectation.paramPtrs != nil {
		mmClosePool.mock.t.Fatalf("AuthRepositoryMock.ClosePool mock is already set by ExpectParams functions")
	}

	mmClosePool.defaultExpectation.params = &AuthRepositoryMockClosePoolParams{ctx}
...
// ExpectCtxParam1 sets up expected param ctx for AuthRepository.ClosePool
func (mmClosePool *mAuthRepositoryMockClosePool) ExpectCtxParam1(ctx context.Context) *mAuthRepositoryMockClosePool {
	if mmClosePool.mock.funcClosePool != nil {
		mmClosePool.mock.t.Fatalf("AuthRepositoryMock.ClosePool mock is already set by Set")
	}
	...
	if mmClosePool.defaultExpectation.params != nil {
		mmClosePool.mock.t.Fatalf("AuthRepositoryMock.ClosePool mock is already set by Expect")
	}

	if mmClosePool.defaultExpectation.paramPtrs == nil {
		mmClosePool.defaultExpectation.paramPtrs = &AuthRepositoryMockClosePoolParamPtrs{}
	}
...
// Inspect accepts an inspector function that has same arguments as the AuthRepository.ClosePool
func (mmClosePool *mAuthRepositoryMockClosePool) Inspect(f func(ctx context.Context)) *mAuthRepositoryMockClosePool {
	if mmClosePool.mock.inspectFuncClosePool != nil {
		mmClosePool.mock.t.Fatalf("Inspect function is already set for AuthRepositoryMock.ClosePool")
	}
...
// Return sets up results that will be returned by AuthRepository.ClosePool
func (mmClosePool *mAuthRepositoryMockClosePool) Return() *AuthRepositoryMock {
	if mmClosePool.mock.funcClosePool != nil {
		mmClosePool.mock.t.Fatalf("AuthRepositoryMock.ClosePool mock is already set by Set")
	}

	if mmClosePool.defaultExpectation == nil {
		mmClosePool.defaultExpectation = &AuthRepositoryMockClosePoolExpectation{mock: mmClosePool.mock}
	}
...
// Set uses given function f to mock the AuthRepository.ClosePool method
func (mmClosePool *mAuthRepositoryMockClosePool) Set(f func(ctx context.Context)) *AuthRepositoryMock {
	if mmClosePool.defaultExpectation != nil {
		mmClosePool.mock.t.Fatalf("Default expectation is already set for the AuthRepository.ClosePool method")
	}

	if len(mmClosePool.expectations) > 0 {
		mmClosePool.mock.t.Fatalf("Some expectations are already set for the AuthRepository.ClosePool method")
	}
...
// When sets expectation for the AuthRepository.ClosePool which will trigger the result defined by the following
// Then helper
func (mmClosePool *mAuthRepositoryMockClosePool) When(ctx context.Context) *AuthRepositoryMockClosePoolExpectation {
	if mmClosePool.mock.funcClosePool != nil {
		mmClosePool.mock.t.Fatalf("AuthRepositoryMock.ClosePool mock is already set by Set")
	}

	expectation := &AuthRepositoryMockClosePoolExpectation{
		mock:               mmClosePool.mock,
		params:             &AuthRepositoryMockClosePoolParams{ctx},
		expectationOrigins: AuthRepositoryMockClosePoolExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	mmClosePool.expectations = append(mmClosePool.expectations, expectation)
	return expectation
}

// Then sets up AuthRepository.ClosePool return parameters for the expectation previously defined by the When method

func (e *AuthRepositoryMockClosePoolExpectation) Then() *AuthRepositoryMock {
	return e.mock
}

// Times sets number of times AuthRepository.ClosePool should be invoked
func (mmClosePool *mAuthRepositoryMockClosePool) Times(n uint64) *mAuthRepositoryMockClosePool {
	if n == 0 {
		mmClosePool.mock.t.Fatalf("Times of AuthRepositoryMock.ClosePool mock can not be zero")
	}
...
func (mmClosePool *mAuthRepositoryMockClosePool) invocationsDone() bool {
...
// ClosePool implements mm_repository.AuthRepository
func (mmClosePool *AuthRepositoryMock) ClosePool(ctx context.Context) {
	...
	mm_params := AuthRepositoryMockClosePoolParams{ctx}
	...
	if mmClosePool.ClosePoolMock.defaultExpectation != nil {
		...
		mm_got := AuthRepositoryMockClosePoolParams{ctx}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmClosePool.t.Errorf("AuthRepositoryMock.ClosePool got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			mmClosePool.t.Errorf("AuthRepositoryMock.ClosePool got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmClosePool.t.Fatalf("Unexpected call to AuthRepositoryMock.ClosePool. %v", ctx)

}

// ClosePoolAfterCounter returns a count of finished AuthRepositoryMock.ClosePool invocations
func (mmClosePool *AuthRepositoryMock) ClosePoolAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmClosePool.afterClosePoolCounter)
}

// ClosePoolBeforeCounter returns a count of AuthRepositoryMock.ClosePool invocations
func (mmClosePool *AuthRepositoryMock) ClosePoolBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmClosePool.beforeClosePoolCounter)
}

// Calls returns a list of arguments used in each call to AuthRepositoryMock.ClosePool.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmClosePool *mAuthRepositoryMockClosePool) Calls() []*AuthRepositoryMockClosePoolParams {
	mmClosePool.mutex.RLock()

	argCopy := make([]*AuthRepositoryMockClosePoolParams, len(mmClosePool.callArgs))
...
func (m *AuthRepositoryMock) MinimockClosePoolDone() bool {
...
func (m *AuthRepositoryMock) MinimockClosePoolInspect() {
	for _, e := range m.ClosePoolMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to AuthRepositoryMock.ClosePool at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.ClosePoolMock.invocationsDone() && afterClosePoolCounter > 0 {
		m.t.Errorf("Expected %d calls to AuthRepositoryMock.ClosePool at\n%s but found %d calls",
...
func (mmCreate *mAuthRepositoryMockCreate) Expect(ctx context.Context, data *model.UserDataPrivate) *mAuthRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &AuthRepositoryMockCreateParams{ctx, data}
...
// ExpectDataParam2 sets up expected param data for AuthRepository.Create
func (mmCreate *mAuthRepositoryMockCreate) ExpectDataParam2(data *model.UserDataPrivate) *mAuthRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mAuthRepositoryMockCreate) Inspect(f func(ctx context.Context, data *model.UserDataPrivate)) *mAuthRepositoryMockCreate {
...
func (mmCreate *mAuthRepositoryMockCreate) Set(f func(ctx context.Context, data *model.UserDataPrivate) (i1 int64, err error)) *AuthRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthRepositoryMockCreate) When(ctx context.Context, data *model.UserDataPrivate) *AuthRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &AuthRepositoryMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &AuthRepositoryMockCreateParams{ctx, data},
...
func (mmCreate *AuthRepositoryMock) Create(ctx context.Context, data *model.UserDataPrivate) (i1 int64, err error) {
	...
	mm_params := AuthRepositoryMockCreateParams{ctx, data}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := AuthRepositoryMockCreateParams{ctx, data}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.data != nil && !minimock.Equal(*mm_want_ptrs.data, mm_got.data) {
				mmCreate.t.Errorf("AuthRepositoryMock.Create got unexpected parameter data, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreate.t.Fatalf("Unexpected call to AuthRepositoryMock.Create. %v %v", ctx, data)
	return
}
...
func (mmGet *mAuthRepositoryMockGet) Return(up1 *model.UserDataPublic, err error) *AuthRepositoryMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("AuthRepositoryMock.Get mock is already set by Set")
	}
...
func (mmGet *mAuthRepositoryMockGet) Set(f func(ctx context.Context, id int64) (up1 *model.UserDataPublic, err error)) *AuthRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
func (e *AuthRepositoryMockGetExpectation) Then(up1 *model.UserDataPublic, err error) *AuthRepositoryMock {
...
func (mmGet *AuthRepositoryMock) Get(ctx context.Context, id int64) (up1 *model.UserDataPublic, err error) {
...
func (mmUpdate *mAuthRepositoryMockUpdate) Expect(ctx context.Context, data *model.UserDataPublic) *mAuthRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &AuthRepositoryMockUpdateParams{ctx, data}
...
// ExpectDataParam2 sets up expected param data for AuthRepository.Update
func (mmUpdate *mAuthRepositoryMockUpdate) ExpectDataParam2(data *model.UserDataPublic) *mAuthRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mAuthRepositoryMockUpdate) Inspect(f func(ctx context.Context, data *model.UserDataPublic)) *mAuthRepositoryMockUpdate {
...
func (mmUpdate *mAuthRepositoryMockUpdate) Set(f func(ctx context.Context, data *model.UserDataPublic) (err error)) *AuthRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthRepositoryMockUpdate) When(ctx context.Context, data *model.UserDataPublic) *AuthRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &AuthRepositoryMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &AuthRepositoryMockUpdateParams{ctx, data},
...
func (mmUpdate *AuthRepositoryMock) Update(ctx context.Context, data *model.UserDataPublic) (err error) {
	...
	mm_params := AuthRepositoryMockUpdateParams{ctx, data}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := AuthRepositoryMockUpdateParams{ctx, data}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.data != nil && !minimock.Equal(*mm_want_ptrs.data, mm_got.data) {
				mmUpdate.t.Errorf("AuthRepositoryMock.Update got unexpected parameter data, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmUpdate.t.Fatalf("Unexpected call to AuthRepositoryMock.Update. %v %v", ctx, data)
	return
}
