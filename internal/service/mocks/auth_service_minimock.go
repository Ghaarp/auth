...
//go:generate minimock -i github.com/Ghaarp/auth/internal/service.AuthService -o auth_service_minimock.go -n AuthServiceMock -p mocks
...
type AuthServiceMock struct {
	...
	funcCreate          func(ctx context.Context, data *model.UserDataPrivate) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, data *model.UserDataPrivate)
	...
	funcGet          func(ctx context.Context, id int64) (up1 *model.UserDataPublic, err error)
	...
	funcStopService          func(ctx context.Context)
	funcStopServiceOrigin    string
	inspectFuncStopService   func(ctx context.Context)
	afterStopServiceCounter  uint64
	beforeStopServiceCounter uint64
	StopServiceMock          mAuthServiceMockStopService

	funcUpdate          func(ctx context.Context, data *model.UserDataPublic) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, data *model.UserDataPublic)
...
func NewAuthServiceMock(t minimock.Tester) *AuthServiceMock {
	...
	m.StopServiceMock = mAuthServiceMockStopService{mock: m}
	m.StopServiceMock.callArgs = []*AuthServiceMockStopServiceParams{}
...
func (mmCreate *mAuthServiceMockCreate) Expect(ctx context.Context, data *model.UserDataPrivate) *mAuthServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &AuthServiceMockCreateParams{ctx, data}
...
// ExpectDataParam2 sets up expected param data for AuthService.Create
func (mmCreate *mAuthServiceMockCreate) ExpectDataParam2(data *model.UserDataPrivate) *mAuthServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mAuthServiceMockCreate) Inspect(f func(ctx context.Context, data *model.UserDataPrivate)) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) Set(f func(ctx context.Context, data *model.UserDataPrivate) (i1 int64, err error)) *AuthServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthServiceMockCreate) When(ctx context.Context, data *model.UserDataPrivate) *AuthServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &AuthServiceMockCreateParams{ctx, data},
...
func (mmCreate *AuthServiceMock) Create(ctx context.Context, data *model.UserDataPrivate) (i1 int64, err error) {
	...
	mm_params := AuthServiceMockCreateParams{ctx, data}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockCreateParams{ctx, data}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.data != nil && !minimock.Equal(*mm_want_ptrs.data, mm_got.data) {
				mmCreate.t.Errorf("AuthServiceMock.Create got unexpected parameter data, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreate.t.Fatalf("Unexpected call to AuthServiceMock.Create. %v %v", ctx, data)
	return
}
...
func (mmGet *mAuthServiceMockGet) Return(up1 *model.UserDataPublic, err error) *AuthServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("AuthServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mAuthServiceMockGet) Set(f func(ctx context.Context, id int64) (up1 *model.UserDataPublic, err error)) *AuthServiceMock {
	if mmGet.defaultExpectation != nil {
...
func (e *AuthServiceMockGetExpectation) Then(up1 *model.UserDataPublic, err error) *AuthServiceMock {
...
func (mmGet *AuthServiceMock) Get(ctx context.Context, id int64) (up1 *model.UserDataPublic, err error) {
...
type mAuthServiceMockStopService struct {
	optional           bool
	mock               *AuthServiceMock
	defaultExpectation *AuthServiceMockStopServiceExpectation
	expectations       []*AuthServiceMockStopServiceExpectation

	callArgs []*AuthServiceMockStopServiceParams
	mutex    sync.RWMutex
...
// AuthServiceMockStopServiceExpectation specifies expectation struct of the AuthService.StopService
type AuthServiceMockStopServiceExpectation struct {
	mock               *AuthServiceMock
	params             *AuthServiceMockStopServiceParams
	paramPtrs          *AuthServiceMockStopServiceParamPtrs
	expectationOrigins AuthServiceMockStopServiceExpectationOrigins

	returnOrigin string
	Counter      uint64
}

// AuthServiceMockStopServiceParams contains parameters of the AuthService.StopService
type AuthServiceMockStopServiceParams struct {
	ctx context.Context
}

// AuthServiceMockStopServiceParamPtrs contains pointers to parameters of the AuthService.StopService
type AuthServiceMockStopServiceParamPtrs struct {
	ctx *context.Context
}

// AuthServiceMockStopServiceOrigins contains origins of expectations of the AuthService.StopService
type AuthServiceMockStopServiceExpectationOrigins struct {
	origin    string
	originCtx string
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmStopService *mAuthServiceMockStopService) Optional() *mAuthServiceMockStopService {
	mmStopService.optional = true
	return mmStopService
}

// Expect sets up expected params for AuthService.StopService
func (mmStopService *mAuthServiceMockStopService) Expect(ctx context.Context) *mAuthServiceMockStopService {
	if mmStopService.mock.funcStopService != nil {
		mmStopService.mock.t.Fatalf("AuthServiceMock.StopService mock is already set by Set")
	}

	if mmStopService.defaultExpectation == nil {
		mmStopService.defaultExpectation = &AuthServiceMockStopServiceExpectation{}
	}

	if mmStopService.defaultExpectation.paramPtrs != nil {
		mmStopService.mock.t.Fatalf("AuthServiceMock.StopService mock is already set by ExpectParams functions")
	}

	mmStopService.defaultExpectation.params = &AuthServiceMockStopServiceParams{ctx}
	mmStopService.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
	for _, e := range mmStopService.expectations {
		if minimock.Equal(e.params, mmStopService.defaultExpectation.params) {
			mmStopService.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmStopService.defaultExpectation.params)
		}
	}
...
// ExpectCtxParam1 sets up expected param ctx for AuthService.StopService
func (mmStopService *mAuthServiceMockStopService) ExpectCtxParam1(ctx context.Context) *mAuthServiceMockStopService {
	if mmStopService.mock.funcStopService != nil {
		mmStopService.mock.t.Fatalf("AuthServiceMock.StopService mock is already set by Set")
	}
	...
	if mmStopService.defaultExpectation.params != nil {
		mmStopService.mock.t.Fatalf("AuthServiceMock.StopService mock is already set by Expect")
	}

	if mmStopService.defaultExpectation.paramPtrs == nil {
		mmStopService.defaultExpectation.paramPtrs = &AuthServiceMockStopServiceParamPtrs{}
	}
	mmStopService.defaultExpectation.paramPtrs.ctx = &ctx
	mmStopService.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)

	return mmStopService
}

// Inspect accepts an inspector function that has same arguments as the AuthService.StopService
func (mmStopService *mAuthServiceMockStopService) Inspect(f func(ctx context.Context)) *mAuthServiceMockStopService {
	if mmStopService.mock.inspectFuncStopService != nil {
		mmStopService.mock.t.Fatalf("Inspect function is already set for AuthServiceMock.StopService")
	}

	mmStopService.mock.inspectFuncStopService = f

	return mmStopService
}

// Return sets up results that will be returned by AuthService.StopService
func (mmStopService *mAuthServiceMockStopService) Return() *AuthServiceMock {
	if mmStopService.mock.funcStopService != nil {
		mmStopService.mock.t.Fatalf("AuthServiceMock.StopService mock is already set by Set")
	}

	if mmStopService.defaultExpectation == nil {
		mmStopService.defaultExpectation = &AuthServiceMockStopServiceExpectation{mock: mmStopService.mock}
	}

	mmStopService.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmStopService.mock
}

// Set uses given function f to mock the AuthService.StopService method
func (mmStopService *mAuthServiceMockStopService) Set(f func(ctx context.Context)) *AuthServiceMock {
	if mmStopService.defaultExpectation != nil {
		mmStopService.mock.t.Fatalf("Default expectation is already set for the AuthService.StopService method")
	}

	if len(mmStopService.expectations) > 0 {
		mmStopService.mock.t.Fatalf("Some expectations are already set for the AuthService.StopService method")
	}

	mmStopService.mock.funcStopService = f
	mmStopService.mock.funcStopServiceOrigin = minimock.CallerInfo(1)
	return mmStopService.mock
}

// When sets expectation for the AuthService.StopService which will trigger the result defined by the following
// Then helper
func (mmStopService *mAuthServiceMockStopService) When(ctx context.Context) *AuthServiceMockStopServiceExpectation {
	if mmStopService.mock.funcStopService != nil {
		mmStopService.mock.t.Fatalf("AuthServiceMock.StopService mock is already set by Set")
	}

	expectation := &AuthServiceMockStopServiceExpectation{
		mock:               mmStopService.mock,
		params:             &AuthServiceMockStopServiceParams{ctx},
		expectationOrigins: AuthServiceMockStopServiceExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	mmStopService.expectations = append(mmStopService.expectations, expectation)
	return expectation
}

// Then sets up AuthService.StopService return parameters for the expectation previously defined by the When method

func (e *AuthServiceMockStopServiceExpectation) Then() *AuthServiceMock {
	return e.mock
}

// Times sets number of times AuthService.StopService should be invoked
func (mmStopService *mAuthServiceMockStopService) Times(n uint64) *mAuthServiceMockStopService {
	if n == 0 {
		mmStopService.mock.t.Fatalf("Times of AuthServiceMock.StopService mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmStopService.expectedInvocations, n)
	mmStopService.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmStopService
}

func (mmStopService *mAuthServiceMockStopService) invocationsDone() bool {
	if len(mmStopService.expectations) == 0 && mmStopService.defaultExpectation == nil && mmStopService.mock.funcStopService == nil {
		return true
	}

	totalInvocations := mm_atomic.LoadUint64(&mmStopService.mock.afterStopServiceCounter)
	expectedInvocations := mm_atomic.LoadUint64(&mmStopService.expectedInvocations)

	return totalInvocations > 0 && (expectedInvocations == 0 || expectedInvocations == totalInvocations)
}

// StopService implements mm_service.AuthService
func (mmStopService *AuthServiceMock) StopService(ctx context.Context) {
	mm_atomic.AddUint64(&mmStopService.beforeStopServiceCounter, 1)
	defer mm_atomic.AddUint64(&mmStopService.afterStopServiceCounter, 1)

	mmStopService.t.Helper()

	if mmStopService.inspectFuncStopService != nil {
		mmStopService.inspectFuncStopService(ctx)
	}

	mm_params := AuthServiceMockStopServiceParams{ctx}

	// Record call args
	mmStopService.StopServiceMock.mutex.Lock()
	mmStopService.StopServiceMock.callArgs = append(mmStopService.StopServiceMock.callArgs, &mm_params)
	mmStopService.StopServiceMock.mutex.Unlock()

	for _, e := range mmStopService.StopServiceMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
			return
		}
	...
	if mmStopService.StopServiceMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmStopService.StopServiceMock.defaultExpectation.Counter, 1)
		mm_want := mmStopService.StopServiceMock.defaultExpectation.params
		mm_want_ptrs := mmStopService.StopServiceMock.defaultExpectation.paramPtrs

		mm_got := AuthServiceMockStopServiceParams{ctx}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmStopService.t.Errorf("AuthServiceMock.StopService got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmStopService.StopServiceMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmStopService.t.Errorf("AuthServiceMock.StopService got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmStopService.StopServiceMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		return

	}
	if mmStopService.funcStopService != nil {
		mmStopService.funcStopService(ctx)
		return
	}
	mmStopService.t.Fatalf("Unexpected call to AuthServiceMock.StopService. %v", ctx)

}

// StopServiceAfterCounter returns a count of finished AuthServiceMock.StopService invocations
func (mmStopService *AuthServiceMock) StopServiceAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmStopService.afterStopServiceCounter)
}

// StopServiceBeforeCounter returns a count of AuthServiceMock.StopService invocations
func (mmStopService *AuthServiceMock) StopServiceBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmStopService.beforeStopServiceCounter)
}

// Calls returns a list of arguments used in each call to AuthServiceMock.StopService.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmStopService *mAuthServiceMockStopService) Calls() []*AuthServiceMockStopServiceParams {
	mmStopService.mutex.RLock()

	argCopy := make([]*AuthServiceMockStopServiceParams, len(mmStopService.callArgs))
	copy(argCopy, mmStopService.callArgs)

	mmStopService.mutex.RUnlock()

	return argCopy
}

// MinimockStopServiceDone returns true if the count of the StopService invocations corresponds
// the number of defined expectations
func (m *AuthServiceMock) MinimockStopServiceDone() bool {
	if m.StopServiceMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}

	for _, e := range m.StopServiceMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}

	return m.StopServiceMock.invocationsDone()
}

// MinimockStopServiceInspect logs each unmet expectation
func (m *AuthServiceMock) MinimockStopServiceInspect() {
	for _, e := range m.StopServiceMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to AuthServiceMock.StopService at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}

	afterStopServiceCounter := mm_atomic.LoadUint64(&m.afterStopServiceCounter)
	// if default expectation was set then invocations count should be greater than zero
	if m.StopServiceMock.defaultExpectation != nil && afterStopServiceCounter < 1 {
		if m.StopServiceMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to AuthServiceMock.StopService at\n%s", m.StopServiceMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to AuthServiceMock.StopService at\n%s with params: %#v", m.StopServiceMock.defaultExpectation.expectationOrigins.origin, *m.StopServiceMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcStopService != nil && afterStopServiceCounter < 1 {
		m.t.Errorf("Expected call to AuthServiceMock.StopService at\n%s", m.funcStopServiceOrigin)
	}

	if !m.StopServiceMock.invocationsDone() && afterStopServiceCounter > 0 {
		m.t.Errorf("Expected %d calls to AuthServiceMock.StopService at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.StopServiceMock.expectedInvocations), m.StopServiceMock.expectedInvocationsOrigin, afterStopServiceCounter)
	}
}
...
func (mmUpdate *mAuthServiceMockUpdate) Expect(ctx context.Context, data *model.UserDataPublic) *mAuthServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &AuthServiceMockUpdateParams{ctx, data}
...
// ExpectDataParam2 sets up expected param data for AuthService.Update
func (mmUpdate *mAuthServiceMockUpdate) ExpectDataParam2(data *model.UserDataPublic) *mAuthServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mAuthServiceMockUpdate) Inspect(f func(ctx context.Context, data *model.UserDataPublic)) *mAuthServiceMockUpdate {
...
func (mmUpdate *mAuthServiceMockUpdate) Set(f func(ctx context.Context, data *model.UserDataPublic) (err error)) *AuthServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthServiceMockUpdate) When(ctx context.Context, data *model.UserDataPublic) *AuthServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &AuthServiceMockUpdateParams{ctx, data},
...
func (mmUpdate *AuthServiceMock) Update(ctx context.Context, data *model.UserDataPublic) (err error) {
	...
	mm_params := AuthServiceMockUpdateParams{ctx, data}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockUpdateParams{ctx, data}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.data != nil && !minimock.Equal(*mm_want_ptrs.data, mm_got.data) {
				mmUpdate.t.Errorf("AuthServiceMock.Update got unexpected parameter data, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmUpdate.t.Fatalf("Unexpected call to AuthServiceMock.Update. %v %v", ctx, data)
	return
}
