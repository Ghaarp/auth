...
// Validate checks the field values on PrivateUser with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *PrivateUser) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PrivateUser with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in PrivateUserMultiError, or
// nil if none found.
func (m *PrivateUser) ValidateAll() error {
	return m.validate(true)
}

func (m *PrivateUser) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return PrivateUserMultiError(errors)
	}

	return nil
}

// PrivateUserMultiError is an error wrapping multiple validation errors
// returned by PrivateUser.ValidateAll() if the designated constraints aren't met.
type PrivateUserMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PrivateUserMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PrivateUserMultiError) AllErrors() []error { return m }

// PrivateUserValidationError is the validation error returned by
// PrivateUser.Validate if the designated constraints aren't met.
type PrivateUserValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PrivateUserValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PrivateUserValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PrivateUserValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PrivateUserValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PrivateUserValidationError) ErrorName() string { return "PrivateUserValidationError" }

// Error satisfies the builtin error interface
func (e PrivateUserValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = PrivateUserValidationError{}
...
func (m *CreateRequest) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetName()); l < 1 || l > 5 {
